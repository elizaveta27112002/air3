...
namespace Airlines3.DataSetAirlinesTableAdapters {
    ...
    public partial class CountriesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Airlines3.Properties.Settings.Default.Session1_02ConnectionString;
        }
...
SELECT ID, RoleID, Email, Password, FirstName, LastName, OfficeID, Birthdate, Active FROM Users WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT ID FROM Users WHERE Email = @Login AND Password = CONVERT(varchar(32), HAS" +
            ...
            this._commandCollection[2].CommandText = "SELECT RoleID FROM Users WHERE Email = @Login AND Password = CONVERT(varchar(32)," +
